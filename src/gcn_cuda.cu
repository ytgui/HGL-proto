...
__global__ void _gcn_forward_kernel(
...
torch::Tensor _gcn_forward_cuda(const torch::Tensor &indptr,
    ...
    _gcn_forward_kernel<int32_t, float><<<n_nodes, min(32, n_features)>>>(
